...
<%@ include file="../menuAdmin.jsp"%>
	<div class="container" align="center">
		...
		<a href="${path}/list/pageNum/${pageNum}" class="btn btn-success">목록</a>
		<a href="${path}/updateForm/num/${board.num}/pageNum/${pageNum}" class="btn btn-success">수정</a>
		<a href="${path}/deleteForm/num/${board.num}/pageNum/${pageNum}" class="btn btn-success">삭제</a> <a
			href="${path}/insertForm/nm/${board.num}/pageNum/${pageNum}" class="btn btn-success">답변</a>
		<p>
		</div>
		<div class="vegemarket-card">
			<form name="frm" id="frm">
				...
				<table>
					<tr>
						...
						<td width=80><input type="button" class="btn btn-success" value="확인" id="repInsert"></td>
					</tr>
				</table>	
			</form>
			</div>
